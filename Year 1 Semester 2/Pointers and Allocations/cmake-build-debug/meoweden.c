...
//    mergeSortDOWN(polynom1,size1);
//    mergeSortDOWN(polynom2,size2);
...
void printPolySum(Monom* polynom1, int size1, Monom* polynom2, int size2){
    ...
    if(copyPoly1 == NULL || copyPoly2 == NULL) //check if allocation failed
        exit(1);
...
Monom* sumSamePower(Monom* polynom1, int* size) {
    ...
    Monom* newPoly = (Monom*)malloc((*size) * sizeof(Monom));
